...
# 输入 txt（存放所有路径）
INPUT_TXT = r"C:\Users\chz62985\Desktop\cipv_lixiang2.txt"

# 输出目录
OUTPUT_DIR = r"C:\Users\chz62985\Desktop\cipv"

# 三个时间区间
RANGES = {
    "cipv_lixiang2_20250824": (
        datetime(2025, 8, 24),
        datetime(2025, 9, 22)
    ),
    "cipv_lixiang2_20250923": (
        datetime(2025, 9, 23),
        datetime(2025, 10, 9)
    ),
    "cipv_lixiang2_20251010": (
        datetime(2025, 10, 10),
        datetime(2026, 1, 1)
    )
}
