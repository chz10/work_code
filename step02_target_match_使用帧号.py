...
def make_parser():
    ...
    parser.add_argument(
        ...
        "--回灌后的arc算法结果",
        type=str,
        default=r'\\hz-iotfs02\Model_Test\TestSpace\Personal_Space\ZYF1\SouthLake\adas_perception_v3.1_SPC030_2m\output_test\shaoyuqi\20250204_V3.1.27223.1538_2M',
    ...
    parser.add_argument(
        ...
        type=str,
        # default=r'',
        default=r"\\Material\xuekangkang\download\1218982",
