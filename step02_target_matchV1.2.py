...
if __name__ == '__main__':
    try:
        mode = False
        src_path = r'\\hz-iotfs02\Model_Test\TestSpace\Personal_Space\CHZ\Southlake\adas_perception_v3.1_SPC030_2m_80\output\shaoyuqi\20260116_V3.1_2M_3.1.27223.1457'
        virtual_test_set_path = r"\\hz-iotfs02\Function_Test\Front_Camera\#24658_FT_ADAS\shaoyuqi\cesucejuV3"
        # SpecialProject_labelfile = r"F:\Desktop\python_tools\专项\目标与车道线横向位置关系专项\result\压线检测统计结果.xlsx"
        SpecialProject_labelfile = r"\\hz-iotfs02\Model_Test\TestSpace\Personal_Space\YJ\专项\目标与车道线位置关系\目标与车道线关系_场景筛选结果20260127.xlsx"
